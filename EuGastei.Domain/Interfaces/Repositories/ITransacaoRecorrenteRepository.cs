...
{
    public interface ITransacaoRecorrenteRepository
    {
        ...
        Task RemoverAsync(TransacaoRecorrente transacaoRecorrente, CancellationToken cancellation = default);
        Task<ICollection<TransacaoRecorrente>> ListarAsync(Expression<Func<TransacaoRecorrente, bool>>? condicao = null,
